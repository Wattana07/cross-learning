...
export async function createBooking(booking: {
  ...
  if (!data.ok) {
    ...
    throw new Error(reasonMessages[data.reason] || data.reason || 'เกิดข้อผิดพลาดในการจอง')
  }
...
export async function updateBooking(booking: {
  ...
  if (!data.ok) {
    ...
    throw new Error(reasonMessages[data.reason] || data.reason || 'เกิดข้อผิดพลาดในการแก้ไข')
  }
