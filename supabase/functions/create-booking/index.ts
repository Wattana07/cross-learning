              ...
              <div class="email-wrapper">
                ...
                <div class="content">
                  ...
                  <p style="color: #6b7280; font-size: 16px; margin-bottom: 30px; line-height: 1.8;">
                    การจองห้องประชุมของคุณได้รับการบันทึกเรียบร้อยแล้ว และกำลังรอการอนุมัติจากผู้ดูแลระบบ
                  </p>
                  
                  <div class="status-badge">⏳ รอการอนุมัติ</div>
                  ...
                  <p style="color: #6b7280; font-size: 14px; margin-top: 30px; line-height: 1.8;">
                    คุณจะได้รับอีเมลแจ้งเตือนอีกครั้งเมื่อการจองได้รับการอนุมัติ
                  </p>
...
อีเมลนี้ถูกส่งอัตโนมัติ กรุณาอย่าตอบกลับ
          ...
          const userEmailResponse = await fetch('https://api.resend.com/emails', {
            ...
            body: JSON.stringify({
              ...
              to: userEmail,
              subject: `การจองห้องประชุม: ${title}`,
              html: userEmailHtml,
              text: userEmailText,
